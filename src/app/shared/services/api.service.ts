...
export class ApiService {
  ...
  public get<T>(path: string, params: any = {}): Observable<T> {
    return this.httpClient.get<T>(`${environment.apiBaseUrl}/${path}`, {
      params,
    });
  }

  public put<T>(path: string, obj: T): Observable<T> {
    return this.httpClient.put<T>(`${environment.apiBaseUrl}/${path}`, obj);
  }

  public post<T>(path: string, obj: T): Observable<T> {
    return this.httpClient.post<T>(`${environment.apiBaseUrl}/${path}`, obj);
  }
